...
const ModalDeleteSuscripcion: React.FC<ConfirmacionUsuarioProps> = ({
  user,
  onClose,
  handleUpdate,
}) => {
    ...
    >
      <Modal.Header>
        <Text h4 css={{ fontWeight: "normal", textAlign: "center" }}>
          {t("modalDeleteSuscripcion.confirmDelete")}
        </Text>
      </Modal.Header>
      <Modal.Body>
      ...
      <Modal.Footer style={{ alignSelf: "center" }}>
        <Button auto color="success" onPress={confirmHandler}>
          {t("modalDeleteSuscripcion.confirm")}
        </Button>
        <Button auto color="error" onPress={onClose}>
          {t("modalDeleteSuscripcion.cancel")}
        </Button>
      </Modal.Footer>
    </Modal>
  );
...
export default ModalDeleteSuscripcion;
